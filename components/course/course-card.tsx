...
export default function CourseCard({ data }: Readonly<{ data: Course }>) {
  return (
    <Link href={ROUTES.PUBLIC.COURSES.DETAIL(data.id)}>
      <Card className="w-full transition-all duration-300 hover:-translate-y-1">
        <div className="flex flex-row md:flex-col px-4 md:px-5 gap-3 md:gap-4">
